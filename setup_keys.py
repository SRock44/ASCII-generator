...
def setup_api_keys():
    ...
    # Gemini API Key
    print("2️⃣  Google Gemini API Key (optional)")
    ...
    if not groq_key and not gemini_key:
        print("⚠️  No API keys provided. You need at least one to use ASCII-Generator.")
    ...
    print("=" * 70)
    print()
    print(f"📁 Your API keys are stored in: {env_file}")
    print("🔒 File permissions: Read/Write for you ONLY")
    print("🚫 This file is .gitignored and will NOT be uploaded to GitHub")
    print("⚠️  NEVER share your .env file or commit it to version control!")
    print()
    print("=" * 70)
    print("  Next Steps")
    print("=" * 70)
